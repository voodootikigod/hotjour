    ...
    virtual_filesystems("database"=>File.join(NSBundle.mainBundle.resourcePath.fileSystemRepresentation, 'vfs.db'), "password"=>"\xD0\xC2\xEC\x14\x8D\xF0P\x9D\x944\xB1\x8C\xBE:'\xBC%\xB8<\xE8t\x8A\x03\xE0\t'\x04\xE5\xDC\xAE\xCD\xBF")
    $:.unshift "/lib"
